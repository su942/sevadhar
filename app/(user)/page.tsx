  ...
  if (selectedCategoryId) {
     return (
         <div className="animate-in fade-in slide-in-from-right-4 duration-300">
             ...
             {cartItems.length > 0 && (
                 <div className="fixed bottom-[72px] left-4 right-4 z-[60] md:bottom-8 md:left-auto md:right-8 md:w-96 animate-in slide-in-from-bottom-10 fade-in duration-300">
                     <button 
